"""
Implementation of a spatial cnn that detects motions in still image frames of the inputted video. built on top of the VGG16 network 
trained on ImageNet using keras.
"""
import keras
...
def get_frame(fname, category):
 """
 This function uses opencv to capture all the individual frames in a video and store their pixel values in a matrix X before 
 they can be passed through the CNN
 """
...
"""
the below VGG model convers convolutional alyer 1-5 as per the paper
"""
